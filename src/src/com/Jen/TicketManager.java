...
//        BufferedReader reader = new BufferedReader(new FileReader("repots.txt"));
//        ArrayList<String> repots = new ArrayList<String>();
//        String line = null;
//
...
//        }
//        try {
//            for (line : Files.readAllLines(Paths.get("repots.txt")));
//                System.out.println(line);
//
//        } catch (IOException e) {
//            e.printStackTrace();
